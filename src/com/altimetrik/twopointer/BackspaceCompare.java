...
public class BackspaceCompare {
    ...
    //solve using stacks SC- O(m+n),  TC-O(m+n)
    public static void main(String[] args) { // we solve using two stack
        ...
        System.out.println(BackspaceCompare.compare("xyw#rrmu#p", "xywrrmu#p"));
    }
}
